...
*Наша система Bobryata Survey взаємодіє із користувачами двох типів. Споживачі (клієнти, які проходять опитування) та організації Ділові процеси системи  стосуються двох типів користувачів: клієнтів та організацій.
