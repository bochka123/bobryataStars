...
Основна мета даної роботи- це пошук найкращої системи для управління експертними оцінками. Так як, система управління у експертному світі ппосідає одну із передових позицій і неможливо уявити будь-яке опитування без такої системи, адже вона значно спрощує проведення маштабних опитувань. Дана система має передбачувати: 
-зручне створення 
-редагування
-керування
-внесення змін
